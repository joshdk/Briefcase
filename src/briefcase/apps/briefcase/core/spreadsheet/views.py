...
from briefcase.apps.briefcase.core.spreadsheet.models import Spreadsheet
import json
from briefcase.apps.briefcase.core.spreadsheet.SpreadsheetSession import SpreadsheetSession, ClientList
...
@login_required
def new(request):
    ss = Spreadsheet(owner=request.user, file_name="New Spreadsheet", module="briefcase.apps.briefcase.core.spreadsheet.views.home")
    ss.save()
    url = {"url":reverse('briefcase.apps.briefcase.core.spreadsheet.views.home', args=[ss.pk])}
